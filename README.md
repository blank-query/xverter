...
Every cursed edge passes through the same verification as the sane ones — several of them run in the 67-edge matrix on every `xverter test`. Cursed, but checked.
